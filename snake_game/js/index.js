...
// Game function
function main(ctime) {
  window.requestAnimationFrame(main); // we use it while developing game because it provides highest fps and graphics
  //   console.log(ctime);
